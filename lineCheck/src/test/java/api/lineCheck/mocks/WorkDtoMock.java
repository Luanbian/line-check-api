...
public class WorkDtoMock {
    ...
    public WorkDtoMock() {
        ...
        List<String> daysOfTheWeeks = new ArrayList<>();
        daysOfTheWeeks.add("SUNDAY");
        daysOfTheWeeks.add("MONDAY");
        daysOfTheWeeks.add("TUESDAY");
        daysOfTheWeeks.add("WEDNESDAY");
        daysOfTheWeeks.add("THURSDAY");
        daysOfTheWeeks.add("FRIDAY");
        daysOfTheWeeks.add("SATURDAY");
